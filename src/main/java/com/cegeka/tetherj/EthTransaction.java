...
public class EthTransaction {
     ...
     * @param weiValue Amount in wei to send.
     */
     ...
     * @param to       Address to send to.
     * @param weiValue Amount in wei to send.
     * @param gasPrice Gas price to set.
     * @param gasLimit Gas limit to set.
     * @param data     Transaction data to set.
     */
     ...
     * Sign a transaction.
     *
     * @param wallet Wallet to sign with, must be unlocked!
     * @param nonce  Nonce to sign transaction with.
     ...
     * @return Returns signed transaction.
     * @throws WalletLockedException If the wallet is locked, the passphrase was bad.
     */
    public EthSignedTransaction signWithWallet(EthWallet wallet, BigInteger nonce,
